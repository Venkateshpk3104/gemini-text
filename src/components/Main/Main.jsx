...
function Main(){
    ...
    const {onSend,recentPrompt,showResult,loading,resultData, setInput, input} = React.useContext(Context);
    ...
    <div className="main">
        ...
        <div className="main-container">
            ...
            <div className="cards">
                ...
                <div className="card">
                    <p>Improve the readabilty of the code</p>
